...
h.match(/(iPad|iPhone|iPod)/i)?!0:!1,m=h.match(/android/i)||c.platform.match(/android/i)?!0:!1,x=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?x=a.OS_WINDOWS:k?x=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?x=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?x=a.OS_UNIX:m?x=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&(x=a.OS_LINUX);a.os=x;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);
...
0,1,1);a.globalCompositeOperation="multiply";g.width=1;g.height=1;var b=g.getContext("2d");b.fillStyle="#fff";b.fillRect(0,0,1,1);a.drawImage(g,0,0,1,1);return 0===a.getImageData(0,0,1,1).data[0]}();cc.sys.isMobile&&(k=document.createElement("style"),k.type="text/css",document.body.appendChild(k),k.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var w=a.localStorage=b.localStorage;
w.setItem("storage","");w.removeItem("storage");w=null}catch(z){w=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},a.localStorage={getItem:w,setItem:w,removeItem:w,clear:w}}w=!!f.getContext("2d");k=!1;m=document.createElement("CANVAS");if(b.WebGLRenderingContext)try{cc.create3DContext(m,{stencil:!0,preserveDrawingBuffer:!0})&&(k=!0)}catch(A){}w=a.capabilities={canvas:w,opengl:k};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)w.touches=
!0;void 0!==e.onmouseup&&(w.mouse=!0);void 0!==e.onkeyup&&(w.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)w.accelerometer=!0;a.garbageCollect=function(){};a.dumpRoot=function(){};a.restartVM=function(){};a.cleanScript=function(a){};a.isObjectValid=function(a){return a?!0:!1};a.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";
...
n={onFrameRateChange:null,getSecondsPerFrame:function(){return _lastSPF},getFrameRate:function(){return _frameRate},setProfileDuration:function(a){!isNaN(a)&&0<a&&(c=a/cc.DIRECTOR_FPS_INTERVAL)},resumeProfiling:function(){cc.eventManager.addListener(_afterVisitListener,1)},stopProfiling:function(){cc.eventManager.removeListener(_afterVisitListener)},isShowingStats:function(){return _showFPS},showStats:function(){a||this.init();if(cc.LabelTTF&&!_FPSLabel){var c=0,c=cc.winSize.width,b=cc.winSize.height,
d=cc.DIRECTOR_STATS_POSITION,c=c>b?0|b/320*24:0|c/320*24;_FPSLabel=new cc.LabelTTF("000.0","Arial",c);_SPFLabel=new cc.LabelTTF("0.000","Arial",c);_drawsLabel=new cc.LabelTTF("0000","Arial",c);_drawsLabel.setPosition(_drawsLabel.width/2+d.x,5*_drawsLabel.height/2+d.y);_SPFLabel.setPosition(_SPFLabel.width/2+d.x,3*_SPFLabel.height/2+d.y);_FPSLabel.setPosition(_FPSLabel.width/2+d.x,_FPSLabel.height/2+d.y)}_FPSLabel&&(_showFPS=!0)},hideStats:function(){_showFPS=!1},init:function(){a||(_afterVisitListener=
...
k;a[6]=c;a[7]=g;return this};b.determinant=function(){var a=this.mat,b=a[0]*a[4]*a[8]+a[1]*a[5]*a[6]+a[2]*a[3]*a[7];return b-=a[2]*a[4]*a[6]+a[0]*a[5]*a[7]+a[1]*a[3]*a[8]};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var g=b[1],h=b[2],k=b[3],m=b[4],n=b[5],p=b[6],s=b[7],r=b[8],t=c[0],u=c[1],v=c[2],y=c[3],x=c[4],w=c[5],z=c[6],A=c[7],c=c[8];b[0]=a*t+k*u+p*v;b[1]=g*t+m*u+s*v;b[2]=h*t+n*u+r*v;b[3]=h*t+n*u+r*v;b[4]=g*y+m*x+s*w;b[5]=h*y+n*x+r*w;b[6]=a*z+k*A+p*c;b[7]=g*z+m*A+s*c;b[8]=h*z+n*A+r*c;
...
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=t;a[8]=c;a[9]=k;a[11]=u;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],t=k[6],u=k[7],v=k[8],y=k[9],x=k[10],w=k[11],z=k[12],A=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*s+E*v+F*z;d[1]=C*b+D*r+E*y+F*A;d[2]=C*n+D*t+E*x+F*B;d[3]=C*p+D*u+E*w+F*k;d[4]=G*c+H*s+I*v+J*z;d[5]=
G*b+H*r+I*y+J*A;d[6]=G*n+H*t+I*x+J*B;d[7]=G*p+H*u+I*w+J*k;d[8]=K*c+L*s+M*v+N*z;d[9]=K*b+L*r+M*y+N*A;d[10]=K*n+L*t+M*x+N*B;d[11]=K*p+L*u+M*w+N*k;d[12]=O*c+P*s+Q*v+m*z;d[13]=O*b+P*r+Q*y+m*A;d[14]=O*n+P*t+Q*x+m*B;d[15]=O*p+P*u+Q*w+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],t=b[8],u=b[9],v=b[10],y=b[11],x=b[12],w=b[13],z=b[14],A=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*t+E*x;b[1]=B*d+C*p+D*u+E*w;b[2]=B*k+C*s+D*v+E*z;b[3]=B*m+C*r+D*y+E*A;b[4]=F*a+G*n+H*t+I*x;b[5]=F*d+G*p+H*u+I*w;b[6]=F*k+G*s+H*v+I*z;b[7]=F*m+G*r+H*y+I*A;b[8]=J*a+K*n+L*t+M*x;b[9]=J*d+K*p+L*u+M*w;b[10]=J*k+K*s+L*v+M*z;b[11]=J*m+K*r+L*y+M*A;b[12]=N*a+O*n+P*t+c*x;b[13]=N*d+O*p+P*u+c*w;b[14]=N*k+O*s+P*v+c*z;b[15]=N*m+O*r+P*y+c*A;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
this._currentStencilEnabled||a.disable(a.STENCIL_TEST);cc.ClippingNode.WebGLRenderCmd._layer--}})();cc.ACTION_TAG_INVALID=-1;
...
for(var m=e.quads,n=this._displayedColor,n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,s=a._itemHeight,r=0,t=-1;r<d;r++){var u=c.charCodeAt(r)-a._mapStartChar.charCodeAt(0),v=u%a._itemsPerRow,y=0|u/a._itemsPerRow;if(!(0>v||0>y||v*p+p>g||y*s+s>f)){t++;var x;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(v=(2*v*h+1)/(2*g),u=v+(2*h-2)/(2*g),y=(2*y*k+1)/(2*f),x=y+(2*k-2)/(2*f)):(v=v*h/g,u=v+h/g,y=y*k/f,x=y+k/f);var w=m[r],z=w.tl,A=w.tr,B=w.bl,w=w.br;z.texCoords.u=v;z.texCoords.v=y;A.texCoords.u=u;
A.texCoords.v=y;B.texCoords.u=v;B.texCoords.v=x;w.texCoords.u=u;w.texCoords.v=x;B.vertices.x=t*p;B.vertices.y=0;B.vertices.z=0;w.vertices.x=t*p+p;w.vertices.y=0;w.vertices.z=0;z.vertices.x=t*p;z.vertices.y=a._itemHeight;z.vertices.z=0;A.vertices.x=t*p+p;A.vertices.y=a._itemHeight;A.vertices.z=0;z.colors=n;A.colors=n;B.colors=n;w.colors=n}}this.updateContentSize(r,t+1);0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.updateContentSize=function(a,c){var d=this._node,e=d._contentSize;
...
c.y),cc.p(c.x+a.width,c.y),cc.p(c.x+a.width,c.y+a.height),cc.p(c.x,c.y+a.height)];cc._drawingUtil.setDrawColor(0,255,0,255);cc._drawingUtil.drawPoly(a,4,!0)}};a._updateCharColorAndOpacity=function(){}})();cc._globalFontSize=cc.ITEM_SIZE;cc._globalFontName="Arial";cc._globalFontNameRelease=!1;
...
f=c.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return c}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0===b?new cc.Menu:1===b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var res={HelloWorld_png:"res/HelloWorld.png",png_bg:"res/bg.jpg",png_1:"res/1.png",png_2:"res/2.png",png_3:"res/3.png",png_4:"res/4.png",png_5:"res/5.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var HelloWorldLayer=cc.Layer.extend({sprite:null,ctor:function(){this._super();var a=cc.winSize,b=new cc.LabelTTF("Hello World","Arial",38);b.x=a.width/2;b.y=a.height/2+200;this.addChild(b,5);this.sprite=new cc.Sprite(res.HelloWorld_png);this.sprite.attr({x:a.width/2,y:a.height/2});this.addChild(this.sprite,0);return!0}}),HelloWorldScene=cc.Scene.extend({onEnter:function(){this._super();var a=new HelloWorldLayer;this.addChild(a)}});var Candy=cc.Sprite.extend({_type:0,_column:0,_row:0,ctor:function(a,b,c){this._super(eval("res.png_"+(a+1).toString()));this.init(a,b,c)},init:function(a,b,c){this._type=a;this._column=b;this._row=c}});Candy.createRandomType=function(a,b){return new Candy(parseInt(Math.random()*GC.USERDATA.CANDY_TYPE_COUNT),a,b)};var GC=GC||{};GC.USERDATA={CANDY_TYPE_COUNT:5,CANDY_WIDTH:64,MAP_SIZE:10,FALL_ACCELERATION:30};GC.LEVELSDATA=[{limitStep:30,targetScore:500},{limitStep:25,targetScore:1E3},{limitStep:20,targetScore:2E3},{limitStep:20,targetScore:3E3},{limitStep:15,targetScore:4E3},{limitStep:10,targetScore:5E3}];var GameLayer=cc.Layer.extend({_ui:null,_mapPanel:null,_map:null,_level:0,_score:0,_limitStep:0,_steps:0,_targetScore:0,_moving:!1,ctor:function(){this._super();var a=cc.director.getWinSize(),b=new cc.Sprite(res.png_bg);b.attr({x:a.width/2,y:a.height/2});this.addChild(b,-1);b=new cc.ClippingNode;this.addChild(b,2);this._mapPanel=new cc.Layer;this._mapPanel.x=(a.width-GC.USERDATA.CANDY_WIDTH*GC.USERDATA.MAP_SIZE)/2;this._mapPanel.y=(a.height-GC.USERDATA.CANDY_WIDTH*GC.USERDATA.MAP_SIZE)/2;b.addChild(this._mapPanel,
1);a=new cc.DrawNode;a.drawRect(cc.p(this._mapPanel.x,this._mapPanel.y),cc.p(this._mapPanel.x+GC.USERDATA.CANDY_WIDTH*GC.USERDATA.MAP_SIZE,this._mapPanel.y+GC.USERDATA.CANDY_WIDTH*GC.USERDATA.MAP_SIZE),cc.color(0,0,0),1,cc.p(0,0,0));b.stencil=a;"touches"in cc.sys.capabilities?cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:this.onTouchBegan.bind(this)},this._mapPanel):cc.eventManager.addListener({event:cc.EventListener.MOUSE,onMouseDown:this.onMouseDown.bind(this)},
this._mapPanel);this.init();this._ui=new GameUI(this);this.addChild(this._ui,3);return!0},init:function(){this._steps=0;this._level=Storage.getCurrentLevel();this._score=Storage.getCurrentScore();this._limitStep=GC.LEVELSDATA[this._level].limitStep;this._targetScore=GC.LEVELSDATA[this._level].targetScore;this._map=[];for(var a=0;a<GC.USERDATA.MAP_SIZE;a++){for(var b=[],c=0;c<GC.USERDATA.MAP_SIZE;c++){var d=Candy.createRandomType(a,c);this._mapPanel.addChild(d);d.x=a*GC.USERDATA.CANDY_WIDTH+GC.USERDATA.CANDY_WIDTH/
2;d.y=c*GC.USERDATA.CANDY_WIDTH+GC.USERDATA.CANDY_WIDTH/2;b.push(d)}this._map.push(b)}},onTouchBegan:function(a,b){cc.log("onTouchBegan");var c=a.getLocation(),d=Math.floor((c.x-this._mapPanel.x)/GC.USERDATA.CANDY_WIDTH),c=Math.floor((c.y-this._mapPanel.y)/GC.USERDATA.CANDY_WIDTH);cc.log("("+d+","+c+")");this.popCandy(d,c);return!0},onMouseDown:function(a){cc.log("onMouseDown");var b=a.getLocationX();a=a.getLocationY();b=Math.floor((b-this._mapPanel.x)/GC.USERDATA.CANDY_WIDTH);a=Math.floor((a-this._mapPanel.y)/
GC.USERDATA.CANDY_WIDTH);cc.log("("+b+","+a+")");this.popCandy(b,a)},popCandy:function(a,b){cc.log("popCandy_column_row \x3d ",a,b);if(!this._moving){var c=[this._map[a][b]];cc.log("joinCandy \x3d ",c.length);for(var d=0,e=function(a){0>c.indexOf(a)&&(c.push(a),cc.log("pushIntoCandys_joinCandys.length \x3d ",c.length))};d<c.length;){var f=c[d];this.checkCandyExist(f._column-1,f._row)&&this._map[f._column-1][f._row]._type==f._type&&e(this._map[f._column-1][f._row]);this.checkCandyExist(f._column+1,
f._row)&&this._map[f._column+1][f._row]._type==f._type&&e(this._map[f._column+1][f._row]);this.checkCandyExist(f._column,f._row-1)&&this._map[f._column][f._row-1]._type==f._type&&e(this._map[f._column][f._row-1]);this.checkCandyExist(f._column,f._row+1)&&this._map[f._column][f._row+1]._type==f._type&&e(this._map[f._column][f._row+1]);d++}cc.log("joinCandys.length \x3d ",c.length);if(1>=c.length)cc.log("joinCandys.length \x3c\x3d1");else{this._steps++;this.moving=!0;cc.log("@@@@@@@@@@@@@@@@");for(d=
0;d<c.length;d++)cc.log("#######################"),f=c[d],this._mapPanel.removeChild(f),this._map[f._column][f._row]=null;this._score+=c.length*c.length;this.generateNewCandy();this.checkSucceedOrFail()}}},checkCandyExist:function(a,b){if(0<=a&&a<GC.USERDATA.MAP_SIZE&&0<=b&&b<GC.USERDATA.MAP_SIZE)return cc.log("in."),!0;cc.log("out.");return!1},generateNewCandy:function(){cc.log("generateNewCandy.");for(var a=0,b=0;b<GC.USERDATA.MAP_SIZE;b++){for(var c=0,d=0;d<this._map[b].length;d++){var e=this._map[b][d];
if(e){cc.log("else");var f=c;if(0<f){var g=Math.sqrt(2*f/GC.USERDATA.FALL_ACCELERATION);g>a&&(a=g);g=(new cc.MoveTo(g,e.x,e.y-GC.USERDATA.CANDY_WIDTH*f)).easing(cc.easeIn(2));e.runAction(g);e._row-=f;this._map[b][d]=null;this._map[b][e._row]=e}}else cc.log("!candyTemp"),e=Candy.createRandomType(b,GC.USERDATA.MAP_SIZE+c),e.x=e._column*GC.USERDATA.CANDY_WIDTH+GC.USERDATA.CANDY_WIDTH/2,e.y=e._row*GC.USERDATA.CANDY_WIDTH+GC.USERDATA.CANDY_WIDTH/2,this._mapPanel.addChild(e),this._map[b][e._row]=e,c++}for(d=
this._map[b].length;d>=GC.USERDATA.MAP_SIZE;d--)this._map[b].splice(d,1)}this.scheduleOnce(this.finishCandyFalls.bind(this),a)},checkSucceedOrFail:function(){cc.log("checkSucceedOrFail.");cc.log("this._score \x3d ",this._score);cc.log("this._targetScore \x3d ",this._targetScore);cc.log("this._steps \x3d ",this._steps);cc.log("this._limitStep \x3d ",this._limitStep);this._score>=this._targetScore?(this._ui.showSuccess(),this._score+=30*(this._limitStep-this._steps),Storage.setCurrentLevel(this._level+
1),Storage.setCurrentScore(this._score),this.scheduleOnce(function(){cc.director.runScene(new GameScene)},5)):this._steps>=this._limitStep&&(this._ui.showFail(),Storage.setCurrentLevel(0),Storage.setCurrentScore(0),this.scheduleOnce(function(){cc.director.runScene(new GameScene)},5))},finishCandyFalls:function(){this.moving=!1}}),GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}});var GameUI=cc.Layer.extend({_levelText:null,_scoreText:null,_stepText:null,_gameLayer:null,ctor:function(a){this._super();this._gameLayer=a;this.init();this.scheduleUpdate()},init:function(){Wsize=cc.director.getWinSize();var a=new cc.LabelTTF("Level","arial",36);a.attr({x:100,y:Wsize.height-50});a.setColor(cc.color(0,0,0));this.addChild(a);var b=new cc.LabelTTF("1","arial",36);b.attr({x:a.x,y:a.y-40});b.setColor(cc.color(0,0,0));this.addChild(b);this._levelText=b;var c=new cc.LabelTTF("Score","arial",
36);c.attr({x:370,y:a.y});c.setColor(cc.color(0,0,0));this.addChild(c);var d=new cc.LabelTTF("0","arial",36);d.attr({x:c.x,y:b.y});d.setColor(cc.color(0,0,0));this.addChild(d);this._scoreText=d;c=new cc.LabelTTF("Step","arial",36);c.attr({x:620,y:a.y});c.setColor(cc.color(0,0,0));this.addChild(c);a=new cc.LabelTTF("0","arial",36);a.attr({x:c.x,y:b.y});a.setColor(cc.color(0,0,0));this.addChild(a);this._stepText=a},showSuccess:function(){var a=new cc.LayerColor(cc.color(255,150,150),500,500);a.attr({x:(Wsize.width-
a.width)/2,y:(Wsize.height-a.height)/2});this.addChild(a,1);var b=new cc.LabelTTF("\u606d\u559c, \u5df2\u5b8c\u6210\u7b2c"+(this._gameLayer._level+1)+"\u5173, \n\u5269\u4f59\u500d\u657030\u500d\u5956\u52b1\uff01","arial",50);b.setColor(cc.color(0,0,0));b.attr({x:250,y:250});a.addChild(b)},showFail:function(){var a=new cc.LayerColor(cc.color(255,150,150),500,500);a.attr({x:(Wsize.width-a.width)/2,y:(Wsize.height-a.height)/2});this.addChild(a,1);var b=new cc.LabelTTF("   \u5931\u8d25\u4e86,\n\u91cd\u65b0\u5f00\u59cb\u5427\uff01",
"arial",56);b.setColor(cc.color(0,0,0));b.attr({x:250,y:250});a.addChild(b)},update:function(){this._levelText.setString((this._gameLayer._level+1).toString());this._scoreText.setString(this._gameLayer._score.toString());this._stepText.setString((this._gameLayer._limitStep-this._gameLayer._steps).toString())}});var Storage={getCurrentLevel:function(){var a=cc.sys.localStorage.getItem("level")||0;return parseInt(a)},setCurrentLevel:function(a){cc.sys.localStorage.setItem("level",a);return!0},getCurrentScore:function(){var a=cc.sys.localStorage.getItem("score")||0;return parseInt(a)},setCurrentScore:function(a){cc.sys.localStorage.setItem("score",a);return!0}};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new GameScene)},this)};cc.game.run();